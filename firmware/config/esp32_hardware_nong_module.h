...
//                       at the joint, through a 4-bar linkage).
    ...
    #define NONG_PULSE_MAX_DEF     { 2500, 2500, 2400, 2400, 2500, 2500, 2400, 2400, 2500, 2500}
    // Per-joint physical speed limit (deg/s of the JOINT) — the move-time floor.
    // WAIST and SHRUG are both big geared 35kg servos (slower); SHRUG moves
// only a few degrees at the joint but carries both shoulders.
    #define NONG_MAX_DPS_DEF       { 375, 375, 400, 400, 375, 375, 400, 400, 200, 250}
