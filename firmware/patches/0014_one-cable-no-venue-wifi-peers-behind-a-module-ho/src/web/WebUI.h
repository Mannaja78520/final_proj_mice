...
.mtab.on{background:var(--acc);border-color:var(--acc);color:#06121f}
...
<div id="modTabs">
  <button class="mtab on" data-mtab="control" onclick="showTab('control')">Control</button>
  <button class="mtab" data-mtab="files" onclick="showTab('files')">Sequences &amp; files</button>
  <button class="mtab" data-mtab="setup" onclick="showTab('setup')">Setup</button>
</div>
<div class="grid">
