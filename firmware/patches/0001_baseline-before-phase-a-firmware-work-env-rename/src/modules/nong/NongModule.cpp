...
bool NongModule::handleCommand(String argv[], int argc, String& reply) {
    ...
    if (cmd == "SERVO") {
        ...
        int lo, hi, hz; float dps, rng;
        if (t == "mg90s")           { lo = 500; hi = 2400; dps = 400; rng = 180; hz = 50; }
        else if (t == "pdi1181mg")  { lo = 500; hi = 2500; dps = 375; rng = 270; hz = 50; }
        else if (t == "tiankong35") { lo = 500; hi = 2500; dps = 250; rng = 270; hz = 50; }
        else if (t == "generic180") { lo = 500; hi = 2500; dps = 300; rng = 180; hz = 50; }
        else if (t == "generic270") { lo = 500; hi = 2500; dps = 300; rng = 270; hz = 50; }
        else {
